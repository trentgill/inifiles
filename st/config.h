 ...
 */
char font[] = "DejaVu Sans Mono:pixelsize=24:antialias=true:autohint=true";
int borderpx = 2;
...
const char *colorname[] = {
	/* this is the 'eighties' theme from base16 w black bg */
	/* 8 normal colors */
	"black",
	"#f2777a", // red .9490, .4784, .4666
	"#99cc99", // green .6, .8, .6
	"#ffcc66", // yellow 1 .8 .4
	"#6699cc", // lt blue .4 .6 .8
	"#cc99cc", // magenta .8 .6 .8
	"#66cccc", // cyan .4 .8 .8
        "#333333", // this is the highlighted text colour
	//"#d3d0c8", // grey .8275 .8157 .7843

	/* 8 bright colors */
	"#747369", // grey .4549 .4510 .4118
	"#f27a77", // red .949 .4666 .4784
	"#99cc99", // green .6, .8, .6
	"#ffcc66", // yellow 1, .8, .4
	"#6699cc", // blue? .4, .6, .8
	"#cc99cc", // magenta .8 .6 .8
	"#66cccc", // cyan .4 .8 .8
	"#f2f0ec", // white .949 .9412 .9255
        //"#666666", // alt-white
	[255] = 0,

	/* more colors can be added after 255 to use with DefaultXX */
	"#d3d0c8", // cursor clr .8275 .8157 .7843
	"#2d2d2d", // was all 5s.. cursor text clr .1765 .1765 .1765
	"black", // bg colour <use black>
	"#d3d0c8", // bold colour .8275 .8157 .7843
	"#d3d0c8", // fg colour .8275 .8157 .7843
	"#d3d0c8", // selected text .8275 .8157 .7843
	"#515151", // selection .3176 .3176 .3176 <half to .1765?>
};
 ...
 */
unsigned int defaultfg = 261; // main text! << changing main text to brighter white
